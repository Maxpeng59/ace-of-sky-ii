...
**Space** fires ordinary aircraft and directly drops a Balloon-role craft's bombs; **Q/E** climb/descend a Balloon. **Click** fires the selected weapon, **Tab** cycles weapons, **F** fires flares, and **G** drops tanks. Chase camera.
